...
export const metadata = {
  title: "Tour App",
  description:
    "Tour App is a travel agency that provides top-notch travel services.",
  keywords: [
    "travel",
    "agency",
    "travel agency",
  ...
  metadataBase: new URL("https://tour-app.vercel.app"),
  openGraph: {
    title: "Tour App",
    description:
      "Tour app is a travel agency that provides top-notch travel services (fake, personal project).",
    siteName: "Tour app",
    images: [
      {
        url: openGraph.src,
